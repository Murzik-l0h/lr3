...
let verticalAlignType = document.getElementById('verticalAlignType');
let block1 = document.getElementById('block1');
let code1 = document.getElementById('code1');
let visibilityType = document.getElementById('visibilityType');
...
function changeVerticalAlign(){
    block1.style.verticalAlign = verticalAlignType.value;
    code1.value = "vertical-align: " + block1.style.verticalAlign + ";";
}


function changeVisibility(){
    block2.style.visibility = visibilityType.value;
    code2.value = "visibility: " + block2.style.visibility + ";";
}